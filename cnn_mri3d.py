...
#Seperate labeled data into a list of data and labels
...
#Change list to nd array, change labels to integers ex) '0-150' becomes 0, '150-300' becomes 1, '300-450' becomes 2 etc...
y = np.array(labels)
